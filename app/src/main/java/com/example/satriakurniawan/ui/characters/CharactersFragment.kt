...
import com.example.satriakurniawan.R
import com.example.satriakurniawan.databinding.CharactersFragmentBinding
...
class CharactersFragment : Fragment(), CharactersAdapter.CharacterItemListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mypokemon.setOnClickListener {
            findNavController().navigate(
                R.id.action_charactersFragment_to_mycharacterDetailFragment
            )
        }
    }
